...
public class ResourceManagementController {
    ...
    public Result<WorkloadStatsData> getWorkloadStats(
            @Parameter(description = "用户ID") @PathVariable Long userId,
            @Parameter(description = "开始日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
            @Parameter(description = "结束日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate) {
        return Result.success(resourceManagementService.getWorkloadStats(userId, startDate, endDate));
    }
    ...
    public Result<List<WorkloadStatsData>> getTeamWorkloadStats(
            @Parameter(description = "团队ID") @RequestParam(required = false) Long teamId,
            @Parameter(description = "开始日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
            @Parameter(description = "结束日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate) {
        return Result.success(resourceManagementService.getTeamWorkloadStats(teamId, startDate, endDate));
    }
    ...
    public Result<TeamDistributionData> getTeamDistribution(
            @Parameter(description = "团队ID") @PathVariable Long teamId,
            @Parameter(description = "开始日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
            @Parameter(description = "结束日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate) {
        return Result.success(resourceManagementService.getTeamDistribution(teamId, startDate, endDate));
    }
    ...
    public Result<WorkloadAlertData> getWorkloadAlerts(
            @Parameter(description = "团队ID") @RequestParam(required = false) Long teamId,
            @Parameter(description = "预警类型列表") @RequestParam(required = false) List<String> alertTypes) {
        return Result.success(resourceManagementService.getWorkloadAlerts(teamId, alertTypes));
    }
    ...
    public Result<Map<String, Object>> resolveAlert(
        ...
        return Result.success(Map.of("success", success, "message", success ? "预警已处理" : "处理失败"));
    }
    ...
    public Result<ResourceCalendarData> getResourceCalendar(
            @Parameter(description = "团队ID") @RequestParam(required = false) Long teamId,
            @Parameter(description = "用户ID列表") @RequestParam(required = false) List<Long> userIds,
            @Parameter(description = "开始日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
            @Parameter(description = "结束日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate) {
        return Result.success(resourceManagementService.getResourceCalendar(teamId, userIds, startDate, endDate));
    }
    ...
    public Result<ResourceUtilizationData> getResourceUtilization(
            @Parameter(description = "团队ID") @RequestParam(required = false) Long teamId,
            @Parameter(description = "统计周期：DAILY, WEEKLY, MONTHLY") @RequestParam(defaultValue = "WEEKLY") String period,
            @Parameter(description = "开始日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
            @Parameter(description = "结束日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate) {
        return Result.success(resourceManagementService.getResourceUtilization(teamId, period, startDate, endDate));
    }
    ...
    public Result<ProjectConflictData> getProjectConflicts(
            @Parameter(description = "团队ID") @RequestParam(required = false) Long teamId,
            @Parameter(description = "用户ID") @RequestParam(required = false) Long userId,
            @Parameter(description = "开始日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
            @Parameter(description = "结束日期") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate) {
        return Result.success(resourceManagementService.getProjectConflicts(teamId, userId, startDate, endDate));
    }
    ...
    public Result<Map<String, Object>> resolveConflict(
        ...
        return Result.success(Map.of("success", success, "message", success ? "冲突已解决" : "解决失败"));
    }
}