...
('IT', '信息技术', NULL, 1, 1, 1),
('FINANCE', '金融服务', NULL, 1, 2, 1),
('MANUFACTURING', '制造业', NULL, 1, 3, 1),
('HEALTHCARE', '医疗健康', NULL, 1, 4, 1),
('EDUCATION', '教育培训', NULL, 1, 5, 1),
('RETAIL', '零售电商', NULL, 1, 6, 1),
('REALESTATE', '房地产', NULL, 1, 7, 1),
('MEDIA', '传媒娱乐', NULL, 1, 8, 1),
('CONSULTING', '咨询服务', NULL, 1, 9, 1),
('GOVERNMENT', '政府机构', NULL, 1, 10, 1),
('OTHER', '其他行业', NULL, 1, 99, 1)
